...
run_multple_simulations(random_sampling, [100, 1000, 10000], [100], 10, (-2, 0.7), True)

run_multple_simulations(latin_hypercube_sampling, [100, 1000, 10000], [100], 10, (-2, 0.7), True)

run_multple_simulations(orthogonal_sampling, [100, 1000, 10000], [100], 10, (-2, 0.7), True)
